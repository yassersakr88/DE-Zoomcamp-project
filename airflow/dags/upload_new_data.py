...
bigquery_dataset_id = "citibike_tripdata"  # Existing BigQuery dataset
bigquery_table_name = "citibike_trips"     # Existing BigQuery table
...
parser = argparse.ArgumentParser(description="Upload and process new CitiBike data")
